                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                ...
                                <a href="/manga1-details"><span>Read Now</span> <i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="hero__items set-bg" data-setbg="img/hero/opm.jpg">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                <div class="label">Action</div>
                                <h2>One Punch Man</h2>
                                <p>The seemingly ordinary and unimpressive Saitama has a rather unique hobby: being a hero....</p>
                                <a href="#"><span>Read Now</span> <i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="hero__items set-bg" data-setbg="img/hero/sds.jpg">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                <div class="label">Adventure</div>
                                <h2>The Seven Deadly Sins</h2>
                                <p>In a world similar to the European Middle Ages, the feared yet revered Holy Knights of Britannia...</p>
                                <a href="#"><span>Read Now</span> <i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
